...
pub struct VestingDetails {
    ...
    pub vesting_periodicity: u32,
    /// The CRLL tokens to be vested daily
    pub periodic_vesting_token_count: Uint128,
    /// Total amount to be vested over period of time 
    /// This also includes the seed tokens
    pub total_vesting_token_count: Uint128,
    /// Total number of tokens purchased till date
    /// This also includes the seed tokens purchased
    pub total_purchased_tokens_till_now: Uint128,

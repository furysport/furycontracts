...
use cosmwasm_std::{
    to_binary, Addr, CosmosMsg, CustomQuery, Querier, QuerierWrapper, StdResult, Uint128, WasmMsg, WasmQuery,
};
...
impl Cw20Contract {
    ...
    pub fn balance<Q: Querier, T: Into<String>, CQ: CustomQuery>(
        &self,
        querier: &Q,
        address: T,
    ) -> StdResult<Uint128> {
    ...
    pub fn meta<Q: Querier, CQ: CustomQuery>(&self, querier: &Q) -> StdResult<TokenInfoResponse> {
    ...
    pub fn allowance<Q: Querier, T: Into<String>, U: Into<String>, CQ: CustomQuery>(
        &self,
        querier: &Q,
        owner: T,
        spender: U,
    ...
    pub fn minter<Q: Querier, CQ: CustomQuery>(&self, querier: &Q) -> StdResult<Option<MinterResponse>> {
    ...
    pub fn has_allowance<Q: Querier, CQ: CustomQuery>(&self, querier: &Q) -> bool {
        self.allowance::<_, _, _, CQ>(querier, self.addr(), self.addr()).is_ok()
    }
